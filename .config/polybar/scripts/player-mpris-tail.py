...
if args.command is None:
    ...
    match args.command:
        case "play" if current_player:
            current_player.play()
        case "pause" if current_player:
            current_player.pause()
        case "play-pause" if current_player:
            current_player.playpause()
        case "stop" if current_player:
            current_player.stop()
        case "previous" if current_player:
            current_player.previous()
        case "next" if current_player:
            current_player.next()
        case "status" if current_player:
