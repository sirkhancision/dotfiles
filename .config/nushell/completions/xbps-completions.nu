...
def "nu-complete installed-packages" [] {
  xpkg | lines
}
...
export extern "xbps-remove" [
  ...packages: string@"nu-complete installed-packages"         # Name of the packages to operate on
  --config(-C): path                                                # Path to confdir (xbps.d)
  --cachedir(-c): path                                                      # Path to cachedir
  --debug(-d)                                                     # Debug mode shown to stderr
...
export extern "xq" [
  ...packages: string@"nu-complete void-packages" # Name of the packages to query
  -R # Query remote repos
]

export def xqr [query_term: string@"nu-complete void-packages"]: nothing -> record<> {
...
export def xr [...pkg: string@"nu-complete installed-packages"] {
  doas xbps-remove ...$pkg
}

export extern "xrs" [
  ...packages: string@"nu-complete xbps-packages" # Name of the packages to search for
]

export def xrst [search_term: string@"nu-complete xbps-packages"]: nothing -> table<> {
  ^xrs $search_term
